...
while cv2.waitKey(1) < 0:
    ...
    for bbox in bboxes:
        # Adjust bounding box according to the scale factor
        bbox = [int(coord * 2) for coord in bbox]
    ...
    # Resize frameFace to original size
    frameFace = cv2.resize(frameFace, (frame.shape[1], frame.shape[0]))
